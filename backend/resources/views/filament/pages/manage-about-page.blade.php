    ...
    <div 
        x-data="{ 
            ...
            refreshIframe() {
                ...
                const iframe = document.getElementById('about-live-preview-iframe');
                if (iframe) {
        ...
        @about-saved.window="refreshIframe()"
        class="w-full"
    >
                ...
                <form wire:submit="save" class="space-y-6">
                    ...
                    <div class="sticky bottom-4 z-10 p-4 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md rounded-2xl border border-gray-200 dark:border-gray-800 shadow-xl flex items-center justify-between">
                        <div class="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <span class="text-xs sm:text-sm font-medium">Live Canvas Halaman About aktif di sebelah kanan</span>
                        </div>
                ...
                <div class="bg-gray-950 text-white rounded-2xl p-4 shadow-2xl border border-gray-800 space-y-3">
                    ...
                    <div class="flex items-center justify-between pb-3 border-b border-gray-800">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-xs font-semibold tracking-wider uppercase text-gray-200">Preview /about</span>
                        </div>
                        ...
                        <div class="flex items-center gap-1.5">
                            ...
                            <!-- Open external link -->
                            <a 
                                href="{{ $frontendUrl }}/about" 
                                target="_blank" 
                                rel="noopener noreferrer" 
                                class="p-1.5 text-gray-400 hover:text-white hover:bg-white/10 rounded-lg transition-all"
                                title="Buka Halaman About di Tab Baru"
                            >
                    ...
                    <div class="w-full flex justify-center items-center py-2 bg-black/40 rounded-xl overflow-hidden min-h-[640px]">
                        ...
                        >
                            <iframe 
                                id="about-live-preview-iframe"
                                src="{{ $frontendUrl }}/about" 
                    ...
                    <div class="flex items-center justify-between text-[11px] text-gray-400 pt-1">
                        <span class="truncate">Target: <code class="text-amber-300/90 font-mono">{{ $frontendUrl }}/about</code></span>
